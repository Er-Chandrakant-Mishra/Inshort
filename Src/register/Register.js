...
import Iconssssss from 'react-native-vector-icons/Ionicons';
      ...
      <View style={{bottom:'-2%'}}>
        <View style={styles.login_form_container}>
          ...
          <View style={{flexDirection:'row',justifyContent:'space-around'}}>
                  <Iconssssss name="people" size={20} color="#FFFFFF" style={{bottom:'-2%'}}  />     
                          
              <TextInput placeholder='Name' placeholderTextColor='#FFFFFF'  style={{ borderBottomColor:'#12325D',width:'90%',height:37,color:'#FFFFFF',marginLeft:'4%'}}  />
            </View>
            ...
            <View style={{flexDirection:'row',justifyContent:'space-around'}}>
              ...
              <TextInput placeholder='Email' placeholderTextColor='#FFFFFF'  style={{ borderBottomColor:'#12325D',width:'90%',height:37,color:'#FFFFFF',marginLeft:'4%'}}  />
            </View>
            <View style={{borderWidth:1,borderColor:'#12325D',width:'95%',backgroundColor:'#12325D'}} />

            <View style={{flexDirection:'row',justifyContent:'space-around'}}>
            <Iconsssss name='mobile-phone' size={31.5} color="#FFFFFF" />  
                          
              <TextInput placeholder='phone' placeholderTextColor='#FFFFFF'  style={{ borderBottomColor:'#12325D',width:'90%',height:37,color:'#FFFFFF',marginLeft:'4%'}}  />
            </View>
            <View style={{borderWidth:1,borderColor:'#12325D',width:'95%',backgroundColor:'#12325D'}} />
            ...
            <View style={{flexDirection:'row',justifyContent:'space-around',marginTop:'5%'}}>
              ...
              <TextInput placeholder='Confirm password' placeholderTextColor='#FFFFFF' secureTextEntry={!confirm_password} style={{ borderBottomColor:'#12325D',width:'90%',height:37,color:'#FFFFFF',marginLeft:'4%'}}  />
              <TouchableOpacity onPress={() => setConfirm_password(!confirm_password)}>
                 <Iconssss name= {confirm_password ? "eye-off" : "eye"} size={20} color="#FFFFFF" style={{left:'-90%'}} />
              </TouchableOpacity>
            </View>
            <View style={{borderWidth:1,borderColor:'#12325D',width:'95%',backgroundColor:'#12325D'}} />

            <TouchableOpacity style={{width:'100%',height:'18%',backgroundColor:'#FFFFFF',borderRadius:25,justifyContent:'center',bottom:'-10%'}}>
          ...
          <View style={{flexDirection:'row',justifyContent:'center',marginTop:'4%'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Login')}>
              <Text style={{color:'#3C7EEE',fontSize:16}}>Login in</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
